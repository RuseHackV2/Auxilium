...
public class kandidati_login extends Activity implements View.OnClickListener {
    ...
    @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.kandidati_login);
        ...
        logout=(ImageView)findViewById(R.id.imageView15);
        logout.setOnClickListener(this);

        undo=(ImageView)findViewById(R.id.imageView16);
        ...
        public void onClick(View v) {
            ...
            if (v.getId() == ivan_petrov.getId()) {
                startActivity(new Intent(this, registraciq_ivan_login.class));
                finish();
            }
